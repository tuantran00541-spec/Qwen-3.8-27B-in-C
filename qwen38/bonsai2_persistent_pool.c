/* Persistent pthread row pool for Bonsai 2 PTQ1_0/PQ2_0 matvec.
 *
...
static void *qwen_bonsai2_worker_main(void *opaque) {
...
void *qwen_bonsai2_pool_create(int n_threads, size_t max_rows) {
...
void qwen_bonsai2_pool_destroy(void *opaque) {
...
int qwen_bonsai2_pool_matvec_ptq1_0(
        void *opaque,
        const uint8_t *weights, size_t weights_bytes, size_t rows, size_t n,
        const uint8_t *activation, size_t activation_bytes, float *out) {
...
int qwen_bonsai2_pool_matvec_pq2_0(
        void *opaque,
        const uint8_t *weights, size_t weights_bytes, size_t rows, size_t n,
        const uint8_t *activation, size_t activation_bytes, float *out) {
    return qwen_bonsai2_pool_matvec(
...
int qwen_bonsai2_pool_threads(void *opaque) {
    const qwen_bonsai2_pool *p = (const qwen_bonsai2_pool *)opaque;
    return p ? p->n_threads : 0;
}

uint64_t qwen_bonsai2_pool_calls(void *opaque) {
    const qwen_bonsai2_pool *p = (const qwen_bonsai2_pool *)opaque;
    return p ? p->calls : 0;
}
